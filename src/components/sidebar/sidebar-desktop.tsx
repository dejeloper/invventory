...
export function SidebarDesktop({ menuItems }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col absolute z-40 left-0 top-0 md:static h-screen overflow-y-scroll md:overflow-y-auto no-scrollbar w-64 md:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-slate-800 p-4 transition-all duration-200 border-r border-r-slate-200 dark:border-r-slate-700 ease-in-out">
